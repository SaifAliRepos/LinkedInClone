...
function AutohideToast() {
  ...
  return (
    <ToastContainer position="top-end" className='m-2'>
      <ToastFade>
        <ToastFade onClose={() => { return dispatch(REMOVE_ALERT()) }} show={alert} delay={5000} autohide>
          <ToastFade.Header className='bg-light'>
            <img src="https://www.citypng.com/public/uploads/preview/hd-green-notification-bell-icon-transparent-png-1163898502733of1cgqav.png" className="rounded me-2" width="25px" alt="" />
